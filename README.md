...
(If you use NPMPlus access lists, the script will automatically prompt for credentials. Make sure to set 'Satisfy Any/Pass Auth to Upstream' in the access list for this to work properly.)
